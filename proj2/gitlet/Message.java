...
public class Message {
    ...
    static final String COMMAND_DOES_NOT_EXIST_MESSAGE = "No command with that name exists.";
    ...
    static final String COMMIT_DOES_NOT_EXIST_MESSAGE = "No commit with that id exists.";

    /** The message when fast-forwarded merged. */
    static final String FAST_FORWARD_MESSAGE = "Current branch fast-forwarded.";

    /** The message when `gitlet init` and the gitlet repo already exists. */
    static final String GIT_REPO_ALREADY_EXISTS_MESSAGE = "A Gitlet version-control system "
            + "already exists in the current directory.";

    /** The message when gitlet directory is not initialized. */
    static final String NOT_IN_GIT_REPO_MESSAGE = "Not in an initialized Gitlet directory.";

    /** The message when the number of operands is wrong. */
    static final String INCORRECT_OPERANDS_MESSAGE = "Incorrect operands.";

    /** The message when no command. */
    static final String PLEASE_ENTER_COMMAND_MESSAGE = "Please enter a command.";
    ...
    static final String BRANCH_HAS_EXISTED_MESSAGE = "A branch with that name already exists.";

    /** The message when no reason to remove the file. */
    static final String NO_REASON_TO_REMOVE_MESSAGE = "No reason to remove the file.";

    /** The message when file does not exist in the commit. */
    static final String FILE_DOES_NOT_EXISTS_IN_COMMIT_MESSAGE = "File does not exist in that "
            + "commit.";
    ...
    static final String NO_COMMIT_WITH_SPECIFIC_MESSAGE = "Found no commit with that message.";
